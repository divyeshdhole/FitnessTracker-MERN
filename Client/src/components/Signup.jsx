...
const Signup = ({ setIsUser }) => {
    ...
    const handleSignup = async (e) => {
        ...
        try {
            const response = await fetch("https://fitness-tracker-api-dusky.vercel.app/register", {
                method: "POST",
                headers: {
    ...
    return (
        <div className="flex flex-col justify-center items-center w-full bg-gray-100">
            {/* UI Elements */}
            <div className="w-[500px] bg-white p-6 shadow-lg rounded-lg flex flex-col justify-center items-center gap-4">
